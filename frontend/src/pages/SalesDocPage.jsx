                ...
                {visibleRows.map((r, i) => (
                  <tr key={i}>
                    <td data-label="Клиент">
                      ...
                      {/* ИД точки в SalesDoc: по нему строка находится в
                          самом SalesDoc. Без него таблица называет
                          расхождение, но не говорит, какую карточку
                          открывать, — имена в двух системах сплошь и рядом
                          разные. Текст выделяемый: ИД чаще всего копируют.
                          Код 1С из карточки SalesDoc здесь не показываем: это
                          GUID в 36 символов, читать его никто не будет, а
                          строку он растягивает. */}
                      {r.sd_id && (
